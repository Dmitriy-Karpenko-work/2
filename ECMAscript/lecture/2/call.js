...
console.log(Roomba.isFull); // false
// Вызов методов объекта.
// В setTimeout мы передаем не просто наш метод, а функцию, которая привязана к нашему объекту. Метод bind возвращает новую функцию, с уже привязанным контекстом, именно она вызывается по
//истечении времени.
...
times.Roomba.startCleaning.call(Roomba); // I am cleaning... I have started: NaN times.
...
setTimeout(Roomba.startCleaning.bind(Roomba), 1000); // I am leaning... I have started: NaN times.
