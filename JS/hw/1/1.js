...
*/
const userInput = +prompt("ввести температуру в градусах Цельсия");
const temperatureC = userInput;
const temperatureF = (9 / 5) * userInput + 32;
const temperatureFResult = Math.round(temperatureF * 10) / 10;

alert(`Цельсий: ${temperatureC} Фаренгейт: ${temperatureFResult}`);
